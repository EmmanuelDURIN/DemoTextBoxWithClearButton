...
namespace DemoTextBoxWithClearButton
{
  /// <summary>
  ...
  /// être utilisé :
  ///
  ///     xmlns:MyNamespace="clr-namespace:DemoTextBoxWithClearButton"
  ///
  ///
  ...
  /// être utilisé :
  ///
  ///     xmlns:MyNamespace="clr-namespace:DemoTextBoxWithClearButton;assembly=DemoTextBoxWithClearButton"
  ///
  ...
  ///
  ///     <MyNamespace:TextBoxWithClearButton/>
  ///
  /// </summary>
  public class TextBoxWithClearButton : TextBox
  {
    static TextBoxWithClearButton()
    {
      DefaultStyleKeyProperty.OverrideMetadata(typeof(TextBoxWithClearButton), new FrameworkPropertyMetadata(typeof(TextBoxWithClearButton)));
    }
    private Button clearButton;
    public override void OnApplyTemplate()
    {
      // instanciation des objets du template
      base.OnApplyTemplate();
      clearButton = this.GetTemplateChild("clearButton") as Button;
